...
final public class PFApplet extends JApplet{
  ...
  public void init(){
    ...
    c.gridy = 0;
    c.gridx = 1;
    centro.add(new JLabel("              Imagen Original            "),c);
    c.gridx = 5;
    centro.add(new JLabel("Imagen con texto encriptado"),c);
    c.fill=c.BOTH;
    c.weightx =1;
    c.weighty =1;
    c.gridx = 1;
    ...
    guardar=new JButton("Guardar png");
    ...
    aEncriptar=new JTextArea("Texto a encriptar");
    ...
    c.gridx = 0;
    c.gridy = 2;
    pp1.add(new JLabel("Clave: "));
    pp1.add(new JScrollPane(claveEncripta));
    lineaBaja.add(pp1,c);

    encriptar=new JButton("Encriptar Texto");
    ...
    panelPrincipal.addTab("Desencriptar",centroDesencriptado);
    ...
    cargarEncriptado=new JButton("Cargar png");
    c.fill=c.NONE;
    c.weightx =0;
    c.weighty =0;
    c.gridx = 1;
   ...
   /*  ventana.setTitle("Proyecto Final");
                ...
                if (boton==cargar){
                    ...
                    if (seleccion == JFileChooser.APPROVE_OPTION)
                    {
                       ...
                       try{
                           ...
                           JOptionPane.showMessageDialog(null, "No se pudo cargar el archivo "+ fichero.getName());
                       }
                    }
                    ...
                    if (seleccion == JFileChooser.APPROVE_OPTION)
                    {
                       ...
                       try{
                         String pat=fichero.getPath();
                           ...
                           JOptionPane.showMessageDialog(null, "No se pudo guarda el archivo: "+ fichero.getName());
                       }
                    }
                }
                    ...
                    if (seleccion == JFileChooser.APPROVE_OPTION)
                    {
                       ...
                       try{
                           ...
                           JOptionPane.showMessageDialog(null, "No se pudo cargar el archivo "+ fichero.getName());
                             ...
                             JOptionPane.showMessageDialog(null, "Formato o valor de clave de encriptación inválido.");
                  }
                          ...
                          try{
                            ...
                            if (aEnc.length()>0){
                                ...
                                guardar.setEnabled(true);
                                 ...
                                 JOptionPane.showMessageDialog(null, "No hay texto para encriptar");
                            }catch (LimitExcededException esr8){
                                 JOptionPane.showMessageDialog(null, "La imagen es muy pequeña para encriptar el texto actual. Redúzcase el tamaño del texto o elija una imagen más grande.");
                            }
   ...
   private static void desencripta(int c){
     try{
       ...
       System.out.println("texto: "+textoDesencriptado);
